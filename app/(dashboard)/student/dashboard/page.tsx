  ...
  return (
    <div style={{ padding: theme.spacing.xl }}>
      ...
      <div style={cardStyle}>
        ...
        <Link href="/student/myproject" style={{ color: theme.colors.success, fontWeight: 500, textDecoration: "none" }}>Add to group / Create group</Link>
      </div>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: theme.spacing.md }}>
        <Link href="/student/myproject" style={{ ...styles.btnSuccess(), textDecoration: "none" }}>My Project</Link>
        <Link href="/student/myproject" style={{ ...styles.btnSecondary(), textDecoration: "none" }}>Group Members</Link>
      </div>
    </div>
  );
}
