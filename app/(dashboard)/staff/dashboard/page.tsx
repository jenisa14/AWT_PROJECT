  ...
  return (
    <div style={{ padding: theme.spacing.xl }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: theme.spacing.md }}>
        <Link href="/staff/projectgroup" style={{ ...styles.btnPrimary(), textDecoration: "none" }}>Project Groups</Link>
        <Link href="/staff/meeting" style={{ ...styles.btnPrimary(), textDecoration: "none" }}>Meetings</Link>
        <Link href="/staff/attendance" style={{ ...styles.btnSecondary(), textDecoration: "none" }}>Attendance</Link>
      </div>
    </div>
  );
}
